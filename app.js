...
function initApp() {
  ...
  // Restore halaman terakhir dari hash URL (agar tidak balik ke dashboard saat refresh)
  ...
  var startPage = (hashPage && validPages.indexOf(hashPage) !== -1) ? hashPage : "dashboard";
  // Admin-only page guard
  if (startPage === "admin" && currentRole !== "admin") startPage = "dashboard";
  history.replaceState({ page: startPage }, "", "#" + startPage);
  if (startPage !== "dashboard") {
    goPage(startPage, null, true);
  }
}
...
function _renderAdminRekapFromData(all) {
  ...
  function makeParseData(rec) {
    ...
    return {
      dewasa: d.dewasa || 0,
      anak: d.anak || 0,
      pb_dewasa: d.pb_dewasa || 0,
      cb_dewasa: d.cb_dewasa || 0,
      cmb_dewasa: d.cmb_dewasa || 0,
      cmk_dewasa: d.cmk_dewasa || 0,
      asim_dewasa: d.asim_dewasa || 0,
      pib_dewasa: d.pib_dewasa || 0,
      bekerja: d.bekerja || 0,
      narkotika: (d.narkotika_dewasa || 0) + (d.narkotika_anak || 0),
      teroris: (d.teroris_dewasa || 0) + (d.teroris_anak || 0),
      pb_anak: d.pb_anak || 0,
      cb_anak: d.cb_anak || 0,
      cmb_anak: d.cmb_anak || 0,
      cmk_anak: d.cmk_anak || 0,
      asim_anak: d.asim_anak || 0,
      pib_anak: d.pib_anak || 0,
      akot: d.akot || 0,
      diversi: d.diversi || 0,
      sekolah: d.sekolah || 0,
      latker: d.latker || 0,
